...
class Purchaseorder extends \Magento\Payment\Model\Method\AbstractMethod
{
     ...
     * @var string
     */
    protected $_formBlockType = \Bluethink\OfflinePayment\Block\Form\Purchaseorder::class;

    /**
     * @var string
     */
    protected $_infoBlockType = \Bluethink\OfflinePayment\Block\Info\Purchaseorder::class;
